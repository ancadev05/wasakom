        ...
        <div class="card p-3">
            ...
            <form action="{{ url('/update-tipe/' . $laptop_tipe->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-9">
                        <select class="form-select @error('merek') is-invalid @enderror" name="merek" id="merek">
                            ...
                            @foreach ($laptop_merek as $item)
                                <option value="{{ $item->id }}" {{ $laptop_tipe->laptop_merek_id == $item->id ? 'selected' : '' }}>
                                    {{ $item->merek }}</option>
                            @endforeach
                        </select>
                        @error('merek')
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control @error('tipe') is-invalid @enderror" id="tipe" name="tipe" value="{{ $laptop_tipe->tipe }}">
                        @error('tipe')
                            <small class="invalid-feedback"> {{ $message }} </small>
                        @enderror
                    </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control @error('layar_size') is-invalid @enderror mb-2" type="text"
                            name="layar_size" id="layar_size" value="{{ $laptop_tipe->layar_size }}" placeholder='example: 15,6"'>
                        @error('layar_size')
                            <small class="invalid-feedback"> {{ $message }} </small>
                        @enderror
                    </div>
