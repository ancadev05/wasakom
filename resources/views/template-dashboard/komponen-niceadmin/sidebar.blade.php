     ...
     <ul class="sidebar-nav" id="sidebar-nav">
		 ...
		 <li class="nav-item">
			<a class="nav-link collapsed" data-bs-target="#product" data-bs-toggle="collapse" href="#">
				<i class="bi bi-boxes"></i><span>Product</span><i class="bi bi-chevron-down ms-auto"></i>
			</a>
			<ul id="product" class="nav-content collapse " data-bs-parent="#sidebar-nav">
				<li>
					<a href="{{ url('/') }}">
						<i class="bi bi-circle-fill"></i><span>Kategori</span>
					</a>
				</li>
				<li>
					<a href="{{ url('/') }}">
						<i class="bi bi-circle-fill"></i><span>Tipe</span>
					</a>
				</li>
				<li>
					<a href="{{ url('/') }}">
						<i class="bi bi-circle-fill"></i><span>Laptop Total</span>
					</a>
				</li>
			</ul>
		</li>
         ...
         <li class="nav-item">
             <a class="nav-link collapsed" data-bs-target="#laptop" data-bs-toggle="collapse" href="#">
                 <i class="bi bi-laptop"></i><span>Laptop</span><i class="bi bi-chevron-down ms-auto"></i>
             </a>
             <ul id="laptop" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                 <li>
                     <a href="{{ url('/mt') }}">
                         <i class="bi bi-circle-fill"></i><span>Merek dan tipe</span>
                     </a>
                 </li>
                 <li>
                     <a href="{{ url('/laptop') }}">
                         <i class="bi bi-circle-fill"></i><span>Laptop</span>
                     </a>
                 </li>
                 <li>
                     <a href="{{ url('/laptop-total') }}">
                         <i class="bi bi-circle-fill"></i><span>Laptop Total</span>
                     </a>
                 </li>
             </ul>
